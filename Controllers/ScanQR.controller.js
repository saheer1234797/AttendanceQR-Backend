...
const scanQrController = {
  async scanQR(request, response) {
    try {
      ...
      console.log("latitude hai ye "+latitude);
      ...
      const distance = getDistance(
        ...
        //  console.log("qr location heras = "+qrDoc.location.radiusMeters);
      // console.log("distance hear "+distance);
      if (distance > qrDoc.location.radiusMeters) {

          //  console.log("this is if files hears  qr location heras = "+qrDoc.location.radiusMeters);
      // console.log("distance hear "+distance);
